...
public class Post implements Serializable {
    ...
    //notnull signals to the SpringData JPA that this variable is not bto be allowed to be null in the database
//temporal allows us to use the type "Date" in the database & signals to the JPA that these fieldswill house data of that type
//column name designates the name of the column in the database
    @NotNull
    @Temporal(TemporalType.DATE)
